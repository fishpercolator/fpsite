  ...
  */
  head: {
    ...
    meta: [
      ...
      {name: 'og:image', property: 'og:image', content: `${canonical}/fbimage.jpg`},
      {name: 'og:image:alt', property: 'og:image:alt', content: 'A laptop displaying the Fish Percolator website'},
